...
void man(char *name)
{
    ...
    else if(strcmp(name,"iseek")==0)
    {
        ...
        printf("Usage : iseek File_Name ChangeInOffest StartPoint\n");
    }
...
int fstat_file(int fd)
{
    ...
    printf("\n-------Statistical information about filr--------\n");
    printf("file name : %s\n",temp->Filename);
...
int main()
{
    ...
    {
        fflush(stdin);   //juna remove
        strcpy(str,"");  //string rikami
        ...
        if(count==1)
        {
            ...
            else if(strcmp(command[0],"closeall")==0)
            {
             ...
             else if(strcmp(command[0],"help")==0)
             {
              ...
              {
                printf("Terminating the marvellous VFS\n");
                break;
              }
              else
              {
        ...
        else if(strcmp(command[0],"open")==0)
        {
         ...
         else if(strcmp(command[0],"read")==0)
            {
                ...
                ptr=(char *)malloc(sizeof(command[2])+1);
                if(ptr==NULL)
                {
                    printf("ERROR: memory allocation failure\n");
                continue;
